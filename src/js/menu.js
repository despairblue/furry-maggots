(function() {
  ...
  Menu.prototype = {
    ...
    create: function () {
      ...
      this.redAudio = this.game.add.audio('redAudio1', 0.5, true, true);
      this.greenAudio = this.game.add.audio('greenAudio2', 0.5, true, true);

      // start audio loops
      this.soundtrack.play();
      this.redAudio.play('', 0, 0.2);
      this.greenAudio.play('', 0, 0.5);

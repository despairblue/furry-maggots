(function() {
  ...
  Level1.prototype = {
    ...
    update: function() {
      ...
      this.lightFunc(this.bitmap1, light2, this.player2Color, stageCorners, light1);
      this.lightFunc(this.bitmap2, light1, this.player1Color, stageCorners, light2);
...
*/
    ...
    lightFunc: function(bitmap, light, rgbaColor, stageCorners, sth) {
          var points = [];
          var ray = null;
          var intersect;
          var i;
          ...
          bitmap.context.clearRect(light.x - 15, light.y - 20, 30, 40)
          ...
          bitmap.context.beginPath();
          bitmap.context.fillStyle = 'rgba(255, 255, 255, 1)'
          bitmap.context.clearRect(sth.x - 15, sth.y - 20, 30, 40)
          // bitmap.context.arc(light.x, light.y, radius, 0, Math.PI*2, false);
          bitmap.context.closePath()
          bitmap.context.fill();
